const Footer = () => {
    return (
      <footer className="bg-white text-black text-sm py-12 px-6 border-t border-gray-200">
        ...
        <a href="/">
          <img src="/images/logo-durancy.png" alt="Durancy logo" className="h-10 mb-6 md:mb-0" />
        </a>
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex gap-6">
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                <img src="/images/Facebook.png" alt="Facebook" className="w-16 hover:scale-105 transition-transform" />
              </a>
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                <img src="/images/Instagram.png" alt="Instagram" className="w-16 hover:scale-105 transition-transform" />
              </a>
              <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
                <img src="/images/Youtube.png" alt="YouTube" className="w-16 hover:scale-105 transition-transform" />
              </a>
            </div>
          </div>
        </div>
        ...
        {/* Bas de page */}
        <div className="text-center text-xs mt-12 pt-6 border-t border-gray-300 flex flex-col gap-2 md:flex-row md:justify-center md:space-x-4">
